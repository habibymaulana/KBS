                ...
                <form method="POST" action="{{ route('teacher.subjects.store') }}" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <x-text-input id="class_code" name="class_code" type="text" class="mt-1 block w-full"
                                          :value="old('class_code')" placeholder="mis. MATH-X-1" />
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" rows="3"
                                  ...
                                  placeholder="Ringkas materi atau tujuan kelas">{{ old('description') }}</textarea>
